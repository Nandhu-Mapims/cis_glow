...
(`client/src/api/client.js`) applies a blanket 30-second request timeout to `POST
/api/auth/login`, same as every other request. A slow DB (e.g. the 5-minute lockout throttle
