...
import { printStudentIdCard } from '../../utils/printReport';
...
export default function StudentIdCardPanel({ data, busy, onGenerate }) {
  ...
  const handlePrint = () => {
    if (data?.reportHtml) printStudentIdCard(data.reportHtml);
  };
            ...
            {!hasResults ? (
              ...
              <>
                ...
                {canPrint ? (
                  ...
                  <p className="text-muted mb-0">No students with an ID card photo found for the selected criteria.</p>
                )}
              </>
            )}
          </div>
