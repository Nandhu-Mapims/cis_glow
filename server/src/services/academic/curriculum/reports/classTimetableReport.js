...
const PAGE = 'class_time_table.php';

export async function loadClassTimetableReport(memberId, fields = {}, audit = {}) {
...
export async function saveClassTimetableReport(memberId, fields = {}, audit = {}) {
  return loadClassTimetableReport(memberId, fields, audit);
}
